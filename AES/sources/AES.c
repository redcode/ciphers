...
#elif defined(CIPHER_AES_STATIC)
...
#define CIPHER_AES_API_OMIT_FUNCTION_PROTOTYPES

#if defined(CIPHER_AES_USE_LOCAL_HEADER)
#	include "AES.h"
#else
...
CIPHER_AES_API
void aes_128_set_key(AES128 *object, zuint32 const *key, zusize key_size)
	{
...
CIPHER_AES_API
void aes_192_set_key(AES192 *object, zuint32 const *key, zusize key_size)
	{
	zuint32 i, t, u, v, w, j, *e = object->e, *d = object->d;
...
CIPHER_AES_API
void aes_256_set_key(AES256 *object, zuint32 const *key, zusize key_size)
	{
	zuint32 i, t, u, v, w, j, *e = object->e, *d = object->d;
...
CIPHER_AES_API
void aes_128_encipher(AES128 *object, zuint32 const *block, zusize block_size, zuint32 *output)
	{
	zuint32 b0[4], b1[4];
	zuint32 const *k;
...
CIPHER_AES_API
void aes_192_encipher(AES192 *object, zuint32 const *block, zusize block_size, zuint32 *output)
	{
	zuint32 b0[4], b1[4];
	zuint32 const *k;
...
CIPHER_AES_API
void aes_256_encipher(AES256 *object, zuint32 const *block, zusize block_size, zuint32 *output)
	{
	zuint32 b0[4], b1[4];
	zuint32 const *k;
...
CIPHER_AES_API
void aes_128_decipher(AES128 *object, zuint32 const *block, zusize block_size, zuint32 *output)
	{
	zuint32 b0[4], b1[4];
	zuint32 const *k;
...
CIPHER_AES_API
void aes_192_decipher(AES192 *object, zuint32 const *block, zusize block_size, zuint32 *output)
	{
	zuint32 b0[4], b1[4];
	zuint32 const *k;
...
CIPHER_AES_API
void aes_256_decipher(AES256 *object, zuint32 const *block, zusize block_size, zuint32 *output)
	{
	zuint32 b0[4], b1[4];
	zuint32 const *k;
...
#if defined(CIPHER_AES_BUILD_MODULE_ABI)

#	include <Z/ABIs/generic/module.h>

	static ZModuleUnit const units[] = {
		{"AES128", "AES-128", Z_VERSION(1, 0, 0), &abi_cipher_aes_128},
		{"AES192", "AES-192", Z_VERSION(1, 0, 0), &abi_cipher_aes_192},
		{"AES256", "AES-256", Z_VERSION(1, 0, 0), &abi_cipher_aes_256}
	};
