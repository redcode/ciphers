...
CIPHER_TEA_API
void tea_set_key(TEA *object, const zuint32 *key, zsize key_size)
	{
...
CIPHER_TEA_API
void tea_encipher(TEA *object, zuint32 const *block, zsize block_size, zuint32 *output)
	{
	zuint32 y, z, n, sum;
...
CIPHER_TEA_API
void tea_decipher(TEA *object, zuint32 const *block, zsize block_size, zuint32 *output)
	{
	zuint32 y, z, n, sum;
	zuint32	k0 = object->key[0], k1 = object->key[1],
		k2 = object->key[2], k3 = object->key[3];
...
CIPHER_TEA_API
void xtea_encipher(TEA *object, zuint32 const *block, zsize block_size, zuint32 *output)
	{
	zuint32 y, z, sum;
...
CIPHER_TEA_API
void xtea_decipher(TEA *object, zuint32 const *block, zsize block_size, zuint32 *output)
	{
	zuint32 y, z, sum;
...
CIPHER_TEA_API
void xeta_encipher(TEA *object, zuint32 const *block, zsize block_size, zuint32 *output)
	{
	zuint32 y, z, sum;
...
CIPHER_TEA_API
void xeta_decipher(TEA *object, zuint32 const *block, zsize block_size, zuint32 *output)
	{
	zuint32 y, z, sum;
